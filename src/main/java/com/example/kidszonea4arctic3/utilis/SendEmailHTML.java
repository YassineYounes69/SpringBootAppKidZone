...
public class SendEmailHTML {
    ...
    private static final String PASSWORD = "Zebbiohh001";

    public static final String EMAIL_FROM = "ahmedmidassi7@gmail.com";
    ...
    public void sendEmail( String EMAIL_FROM ,String EMAIL_TO , String EMAIL_SUBJECT ,String EMAIL_TEXT ) {
